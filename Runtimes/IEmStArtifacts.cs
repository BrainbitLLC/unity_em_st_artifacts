...
{
    public static class EmStLibNamePropvider
    {
    ...
    public interface IEmotionalMathSDKApi
    {
        ...
        byte MathLibUseInternalFilters(IntPtr mathLibPtr, bool use, ref OpStatus opResult);
        ...
        byte MathLibIsArtifactedLeft(IntPtr mathLibPtr, ref bool result, ref OpStatus opResult);
        byte MathLibIsArtifactedRight(IntPtr mathLibPtr, ref bool result, ref OpStatus opResult);
        ...
        byte MathLibReadTotalPowFromArtifacts(IntPtr mathLibPtr, ref double total_pow_left, ref double total_pow_right, ref OpStatus opResult);
        byte MathLibGetEEGQuality(IntPtr mathLibPtr, ref int q_left, ref int q_right, ref OpStatus opResult);
